...
export const metadata: Metadata = {
  ...
  description:
    "How OpenHospitalCost handles data: analytics, advertising cookies (Google AdSense), the service providers we use, and your choices.",
        ...
        <div className="copy">
          ...
          <ul>
            ...
            <li>
              ...
              your name, email address, and message) in that email.
            </li>
            <li>
          ...
          <p>
            ...
            hosting and analytics (Vercel), database hosting (Neon), and advertising (Google AdSense). We do{" "}
          ...
          <p>
            We keep emails you send us for as long as needed to respond and maintain records, and aggregate usage data
